...
function StorePage() {
  ...
  const { data: merchant } = useQuery({
    ...
    queryFn: async () => (await supabase.from("merchants").select("id,name,slug,logo_url,description,banner_url,is_active,approval_status,owner_id,created_at,updated_at").eq("slug", merchantSlug).maybeSingle()).data,
  });
